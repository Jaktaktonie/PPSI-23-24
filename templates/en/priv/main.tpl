...
<header class="bg-blue-500 text-white p-4 text-center">
    ...
    <nav>
        ...
        <a href="kontakt" class="mr-4">Contact</a>
...
<footer class="bg-blue-500 text-white p-4 text-center w-full flex-end mt-auto">
    ...
    <nav>
        <a href="policy" class="mr-4">Private Policy</a>
    </nav>
</footer>
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        {
            document.getElementById("login_btn").innerHTML='<a href="login" class="mr-4">Login</a>';
        } else
        {
            document.getElementById("login_btn").innerHTML='<a href="logout.php" class="mr-4">Logout</a>';
        }
        const ratings = document.querySelectorAll('.ocena');
        let cards = document.getElementById("cards_content");
        if(cards.childElementCount==0){
            cards.innerHTML="Search something";
        }
        ...
        async function showPosition(position) {
            ...
            try {
                ...
                document.getElementById('temperature').textContent = `Temperature in ${miasto}: ${temperature}°C`;
            } catch (error) {
                document.getElementById('temperature').textContent = 'Problem with getting Temperature.';
        ...
        function showError(error) {
            switch(error.code) {
                case error.PERMISSION_DENIED:
                    document.getElementById('temperature').textContent = "Problem with getting Temperature. Permision Denied.";
                    break;
